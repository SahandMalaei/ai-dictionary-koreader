    ...
    return {
      ...
      callback = function()
        plugin:Query(reader_highlight_instance, "AI Explain", false,
          ...
          "No spoilers if it's fiction. Use Markdown emphasis (*x*) when it helps understanding. Keep your explanation brief (under 80 words, ONLY ONE PARAGRAPH), and ask no questions at the end.",
